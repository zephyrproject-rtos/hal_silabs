...
paths = [
    ...
    "components/device/silabs/si91x/mcu/drivers/unified_api/inc/rsi_d_cache.h",
    ...
    "components/device/silabs/si91x/mcu/drivers/unified_api/src/rsi_d_cache.c",
    ...
    "components/device/silabs/si91x/wireless/crypto/aes/inc/sl_si91x_mp_aes.h",
    ...
    "components/device/silabs/si91x/wireless/crypto/aes/src/sl_si91x_mp_aes.c",
    ...
    "components/device/silabs/si91x/wireless/crypto/ccm/inc/sl_si91x_mp_ccm.h",
    "components/device/silabs/si91x/wireless/crypto/ccm/src/sl_si91x_ccm.c",
    "components/device/silabs/si91x/wireless/crypto/ccm/src/sl_si91x_mp_ccm.c",
    ...
    "components/device/silabs/si91x/wireless/crypto/sha/inc/sl_si91x_sha3.h",
    ...
    "components/device/silabs/si91x/wireless/inc/sli_si91x_driver.h",
    ...
    "components/device/silabs/si91x/wireless/src/sli_si91x_driver.c",
    "components/device/silabs/si91x/wireless/sli_hal_si91x/inc/sli_hal_si91x.h",
    "components/device/silabs/si91x/wireless/sli_hal_si91x/inc/sli_hal_si91x_constants.h",
    "components/device/silabs/si91x/wireless/sli_hal_si91x/inc/sli_hal_si91x_packet.h",
    "components/device/silabs/si91x/wireless/sli_hal_si91x/src/sli_hal_si91x.c",
    ...
    "components/protocol/wifi/src/si91x/sl_wifi.c",
    ...
    "components/service/network_manager/inc/sli_net_credentials.h",
    "components/service/network_manager/src/sli_net_credentials.c",
    "components/service/network_manager/src/si91x/sl_net_credentials.c",
    "components/sli_buffer_manager/inc/sli_buffer_manager.h",
    "components/sli_buffer_manager/inc/sli_buffer_manager_types.h",
    "components/sli_buffer_manager/src/sli_buffer_manager.c",
    "components/device/silabs/si91x/wireless/sli_si91x_wifi_event_handler/inc/sli_si91x_wifi_event_handler.h",
    "components/device/silabs/si91x/wireless/sli_si91x_wifi_event_handler/src/sli_si91x_wifi_event_handler.c",
    "components/device/silabs/si91x/wireless/sli_si91x_wifi_command_engine/inc/sli_si91x_wifi_command_engine.h",
    "components/device/silabs/si91x/wireless/sli_si91x_wifi_command_engine/inc/sli_si91x_wifi_command_engine_packet.h",
    "components/device/silabs/si91x/wireless/sli_si91x_wifi_command_engine/inc/sli_wifi_command_engine_config.h",
    "components/device/silabs/si91x/wireless/sli_si91x_wifi_command_engine/src/sli_si91x_wifi_command_engine.c",
    "components/device/silabs/si91x/wireless/sli_si91x_wifi_command_engine/src/sli_si91x_wifi_command_engine_config.c",
    "components/sli_command_engine/inc/sli_command_engine.h",
    "components/sli_command_engine/src/sli_command_engine.c",
    "components/sli_event_engine/inc/sli_event_engine.h",
    "components/sli_event_engine/src/sli_event_engine.c",
    "components/sli_queue_manager/inc/sli_queue_manager.h",
    "components/sli_queue_manager/inc/sli_queue_manager_types.h",
    "components/sli_queue_manager/src/sli_queue_manager.c",
    "components/sli_routing_utility/inc/sli_routing_utility.h",
    "components/sli_routing_utility/inc/sli_routing_utility_types.h",
    "components/sli_routing_utility/src/sli_routing_utility.c",
    "components/sli_wifi/inc/sli_wifi_constants.h",
    "components/sli_wifi/inc/sli_wifi.h",
    "components/sli_wifi/inc/sli_wifi_device_core_utilities.h",
    ...
    "components/sli_wifi/src/sli_wifi_power_profile.c",

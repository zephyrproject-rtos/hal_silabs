...
#define SL_WFX_BIT(n) (1 << (n))

/* Control register bit set */
#define SL_WFX_CONT_REGISTER_SIZE      (0x02)
#define SL_WFX_CONT_NEXT_LEN_MASK      (0x0FFF)
#define SL_WFX_CONT_WUP_BIT            (SL_WFX_BIT(12))
#define SL_WFX_CONT_RDY_BIT            (SL_WFX_BIT(13))
#define SL_WFX_CONT_FRAME_TYPE_INFO    (SL_WFX_BIT(14) | SL_WFX_BIT(15))
#define SL_WFX_CONT_FRAME_TYPE_OFFSET  (0x0E)

/* Config register bit set */
#define SL_WFX_CONFIG_ERROR_CSN_FRAME     (SL_WFX_BIT(0))
#define SL_WFX_CONFIG_ERROR_READ_UNDERRUN (SL_WFX_BIT(1))
#define SL_WFX_CONFIG_ERROR_READ_LESS     (SL_WFX_BIT(2))
#define SL_WFX_CONFIG_FRAME_READ_ENTRY    (SL_WFX_BIT(3))
#define SL_WFX_CONFIG_ERROR_SEND_OVERRUN  (SL_WFX_BIT(4))
#define SL_WFX_CONFIG_ERROR_SEND_LARGE    (SL_WFX_BIT(5))
#define SL_WFX_CONFIG_ERROR_SEND_ENTRY    (SL_WFX_BIT(6))
#define SL_WFX_CONFIG_CSN_FRAME_BIT       (SL_WFX_BIT(7))
#define SL_WFX_CONFIG_ERROR_MASK          (0x000F)
/* Word mode config */
#define SL_WFX_CONFIG_WORD_MODE_BITS   (SL_WFX_BIT(8) | SL_WFX_BIT(9))
#define SL_WFX_CONFIG_WORD_MODE_1      (SL_WFX_BIT(8))
#define SL_WFX_CONFIG_WORD_MODE_2      (SL_WFX_BIT(9))
/* QueueM */
#define SL_WFX_CONFIG_ACCESS_MODE_BIT  (SL_WFX_BIT(10))
/* AHB bus */
#define SL_WFX_CONFIG_AHB_PRFETCH_BIT  (SL_WFX_BIT(11))
#define SL_WFX_CONFIG_CPU_CLK_DIS_BIT  (SL_WFX_BIT(12))
/* APB bus */
#define SL_WFX_CONFIG_PRFETCH_BIT      (SL_WFX_BIT(13))
/* CPU reset */
#define SL_WFX_CONFIG_CPU_RESET_BIT    (SL_WFX_BIT(14))
#define SL_WFX_CONFIG_CLEAR_INT_BIT    (SL_WFX_BIT(15))
/* For WF200 the IRQ Enable and Ready Bits are in CONFIG register */
#define SL_WFX_CONFIG_DATA_IRQ_ENABLE  (SL_WFX_BIT(16))
#define SL_WFX_CONFIG_WUP_IRQ_ENABLE   (SL_WFX_BIT(17))
#define SL_WFX_CONFIG_DATA_WUP_ENABLE  (SL_WFX_BIT(16) | SL_WFX_BIT(17))
/* Revision and type */

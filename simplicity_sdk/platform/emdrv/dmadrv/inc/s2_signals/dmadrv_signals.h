...
SL_ENUM_GENERIC(DMADRV_PeripheralSignal_t, uint32_t) {
  ...
  dmadrvPeripheralSignal_CAN0_RXFL0 = LDMAXBAR_CH_REQSEL_SIGSEL_CAN0RXFL_0 | LDMAXBAR_CH_REQSEL_SOURCESEL_CAN0,
  #endif
  #if defined(LDMAXBAR_CH_REQSEL_SIGSEL_CAN0RXFL_1)
  dmadrvPeripheralSignal_CAN0_RXFL1 = LDMAXBAR_CH_REQSEL_SIGSEL_CAN0RXFL_1 | LDMAXBAR_CH_REQSEL_SOURCESEL_CAN0,
  #endif
  #if defined(LDMAXBAR_CH_REQSEL_SIGSEL_CAN0TXFL_0)
  dmadrvPeripheralSignal_CAN0_TXFL0 = LDMAXBAR_CH_REQSEL_SIGSEL_CAN0TXFL_0 | LDMAXBAR_CH_REQSEL_SOURCESEL_CAN0,
  #endif
  #if defined(LDMAXBAR_CH_REQSEL_SIGSEL_CAN0TXFL_1)
  dmadrvPeripheralSignal_CAN0_TXFL1 = LDMAXBAR_CH_REQSEL_SIGSEL_CAN0TXFL_1 | LDMAXBAR_CH_REQSEL_SOURCESEL_CAN0,
  #endif
};

...
#if defined(_CMU_CLKEN1_CAN_SHIFT)
/// Define CAN peripheral bus clock value.
const uint32_t SL_BUS_CLOCK_CAN0_VALUE = (BUS_CLOCK_CLKEN1 << _BUS_CLOCK_CLKENX_SHIFT) | _CMU_CLKEN1_CAN_SHIFT;
#endif

#if defined(_CMU_CLKEN1_ADC0_SHIFT)
/// Define ADC0 peripheral bus clock value.
const uint32_t SL_BUS_CLOCK_ADC0_VALUE = (BUS_CLOCK_CLKEN1 << _BUS_CLOCK_CLKENX_SHIFT) | _CMU_CLKEN1_ADC0_SHIFT;
#endif

#if defined(_CMU_CLKEN1_ADC1_SHIFT)
/// Define ADC1 peripheral bus clock value.
const uint32_t SL_BUS_CLOCK_ADC1_VALUE = (BUS_CLOCK_CLKEN1 << _BUS_CLOCK_CLKENX_SHIFT) | _CMU_CLKEN1_ADC1_SHIFT;
#endif

#if defined(_CMU_CLKEN1_LEDSINK_SHIFT)
/// Define LEDSINK peripheral bus clock value.
const uint32_t SL_BUS_CLOCK_LEDSINK0_VALUE = (BUS_CLOCK_CLKEN1 << _BUS_CLOCK_CLKENX_SHIFT) | _CMU_CLKEN1_LEDSINK_SHIFT;
#endif

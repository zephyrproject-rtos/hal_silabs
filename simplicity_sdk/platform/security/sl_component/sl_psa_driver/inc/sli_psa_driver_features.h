...
#if defined(SLI_MBEDTLS_DEVICE_HC) && defined(KSU_PRESENT) && defined(SEMAILBOX_PRESENT)
...
#if defined(PSA_WANT_ALG_CCM) && (defined(MBEDTLS_PSA_ACCEL_ALG_CCM) || defined(SLI_MBEDTLS_DEVICE_SI91X))
  #define SLI_PSA_DRIVER_FEATURE_AEAD
  #define SLI_PSA_DRIVER_FEATURE_AEAD_MULTIPART
  #define SLI_PSA_DRIVER_FEATURE_CCM
#endif

#if defined(PSA_WANT_ALG_GCM) && (defined(MBEDTLS_PSA_ACCEL_ALG_GCM) || defined(SLI_MBEDTLS_DEVICE_SI91X))
  #define SLI_PSA_DRIVER_FEATURE_AEAD
  #define SLI_PSA_DRIVER_FEATURE_AEAD_MULTIPART
...
#if defined(PSA_WANT_ALG_CHACHA20_POLY1305) && (defined(MBEDTLS_PSA_ACCEL_ALG_CHACHA20_POLY1305) || defined(SLI_MBEDTLS_DEVICE_SI91X))
  #define SLI_PSA_DRIVER_FEATURE_AEAD
...
// Cipher
...
#if defined(PSA_WANT_KEY_TYPE_AES) && (defined(MBEDTLS_PSA_ACCEL_KEY_TYPE_AES) || defined(SLI_MBEDTLS_DEVICE_SI91X))

  #define SLI_PSA_DRIVER_FEATURE_AES

  #if defined(PSA_WANT_ALG_ECB_NO_PADDING) && (defined(MBEDTLS_PSA_ACCEL_ALG_ECB_NO_PADDING) || defined(SLI_MBEDTLS_DEVICE_SI91X))
  ...
  #if defined(PSA_WANT_ALG_CTR) && (defined(MBEDTLS_PSA_ACCEL_ALG_CTR) || defined(SLI_MBEDTLS_DEVICE_SI91X))
    #define SLI_PSA_DRIVER_FEATURE_CIPHER
    #define SLI_PSA_DRIVER_FEATURE_BLOCK_CIPHER
  ...
  #if defined(PSA_WANT_ALG_CBC_NO_PADDING) && (defined(MBEDTLS_PSA_ACCEL_ALG_CBC_NO_PADDING) || defined(SLI_MBEDTLS_DEVICE_SI91X))
    #define SLI_PSA_DRIVER_FEATURE_CIPHER
    #define SLI_PSA_DRIVER_FEATURE_BLOCK_CIPHER
  ...
  && (defined(MBEDTLS_PSA_ACCEL_KEY_TYPE_CHACHA20) || defined(SLI_MBEDTLS_DEVICE_SI91X))
  #define SLI_PSA_DRIVER_FEATURE_CIPHER
...
#if defined(PSA_WANT_ALG_SHA_1) && (defined(MBEDTLS_PSA_ACCEL_ALG_SHA_1) || defined(SLI_MBEDTLS_DEVICE_SI91X))
...
#if defined(PSA_WANT_ALG_SHA_224) && (defined(MBEDTLS_PSA_ACCEL_ALG_SHA_224) || defined(SLI_MBEDTLS_DEVICE_SI91X))
  #define SLI_PSA_DRIVER_FEATURE_HASH
  #define SLI_PSA_DRIVER_FEATURE_HASH_MULTIPART
...
#if defined(PSA_WANT_ALG_SHA_256) && (defined(MBEDTLS_PSA_ACCEL_ALG_SHA_256) || defined(SLI_MBEDTLS_DEVICE_SI91X))
  #define SLI_PSA_DRIVER_FEATURE_HASH
  #define SLI_PSA_DRIVER_FEATURE_HASH_MULTIPART
...
#if defined(PSA_WANT_ALG_SHA_384) && (defined(MBEDTLS_PSA_ACCEL_ALG_SHA_384) || defined(SLI_MBEDTLS_DEVICE_SI91X))
  #define SLI_PSA_DRIVER_FEATURE_HASH
  #define SLI_PSA_DRIVER_FEATURE_HASH_MULTIPART
...
#if defined(PSA_WANT_ALG_SHA_512) && (defined(MBEDTLS_PSA_ACCEL_ALG_SHA_512) || defined(SLI_MBEDTLS_DEVICE_SI91X))
  #define SLI_PSA_DRIVER_FEATURE_HASH
  #define SLI_PSA_DRIVER_FEATURE_HASH_MULTIPART
...
#if defined(PSA_WANT_ALG_HMAC) && (defined(MBEDTLS_PSA_ACCEL_ALG_HMAC) || defined(SLI_MBEDTLS_DEVICE_SI91X))
  #define SLI_PSA_DRIVER_FEATURE_MAC
  #define SLI_PSA_DRIVER_FEATURE_MAC_MULTIPART
  #define SLI_PSA_DRIVER_FEATURE_HMAC
#endif

#if defined(PSA_WANT_ALG_CMAC) && (defined(MBEDTLS_PSA_ACCEL_ALG_CMAC) || defined(SLI_MBEDTLS_DEVICE_SI91X))
  #define SLI_PSA_DRIVER_FEATURE_MAC
  #define SLI_PSA_DRIVER_FEATURE_MAC_MULTIPART
  #define SLI_PSA_DRIVER_FEATURE_CMAC
#endif

#if defined(PSA_WANT_ALG_CBC_MAC) && (defined(MBEDTLS_PSA_ACCEL_ALG_CBC_MAC) || defined(SLI_MBEDTLS_DEVICE_SI91X))
  #define SLI_PSA_DRIVER_FEATURE_MAC
  #define SLI_PSA_DRIVER_FEATURE_MAC_MULTIPART
...
#if defined(PSA_WANT_ALG_ECDH) && (defined(MBEDTLS_PSA_ACCEL_ALG_ECDH) || defined(SLI_MBEDTLS_DEVICE_SI91X)) \
...
#if defined(PSA_WANT_ALG_ECDSA) && (defined(MBEDTLS_PSA_ACCEL_ALG_ECDSA) || defined(SLI_MBEDTLS_DEVICE_SI91X)) \

...
const uint32_t sl_rail_ieee802154_2p4_high_speed_fcs_1mbps_fec_38M4Hz_modemConfig[] = {
  0x03014FFCUL, (uint32_t) &phyInfo_1,
  0x0002400CUL, 0x0011B10CUL,
  /*    4010 */ 0x00004100UL,
  0x00044030UL, 0x00000825UL,
...
const RAIL_ChannelConfigEntry_t sl_rail_ieee802154_phy_2G4Hz_fcs_1Mbps_fec_38M4Hz_channels[] = {
  ...
  {
    .phyConfigDeltaAdd = sl_rail_ieee802154_2p4_high_speed_fcs_1mbps_fec_38M4Hz_modemConfig,
    .baseFrequency = 2405000000,
    .channelSpacing = 5000000,
    .physicalChannelOffset = 27,
    .channelNumberStart = 27,

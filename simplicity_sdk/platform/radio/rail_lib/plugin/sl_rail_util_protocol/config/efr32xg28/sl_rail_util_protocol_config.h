...
// <SL_RAIL_RF_STATE_RX=> RX
// <i> Default: SL_RAIL_RF_STATE_RX
#define SL_RAIL_UTIL_PROTOCOL_ZWAVE_AUTO_ACK_RX_TRANSITION_STATE  SL_RAIL_RF_STATE_RX
// <o SL_RAIL_UTIL_PROTOCOL_ZWAVE_AUTO_ACK_TX_TRANSITION_STATE> Radio state transition after transmitting ACK
// <SL_RAIL_RF_STATE_IDLE=> Idle
// <SL_RAIL_RF_STATE_RX=> RX
// <i> Default: SL_RAIL_RF_STATE_RX
#define SL_RAIL_UTIL_PROTOCOL_ZWAVE_AUTO_ACK_TX_TRANSITION_STATE  SL_RAIL_RF_STATE_RX
// </e>
// </h>
// </h>

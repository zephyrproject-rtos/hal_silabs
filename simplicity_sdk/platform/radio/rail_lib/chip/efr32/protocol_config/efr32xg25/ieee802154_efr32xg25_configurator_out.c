...
const uint32_t ieee802154_gb868_863_modemConfigBase[] = {
  ...
  0x0102C100UL, 0x00000082UL, /* Write: AGC.COLLDETCTRL */
  /*    C104 */ 0x03FC1606UL, /* AGC.COLLDETTHD */
  ...
  0x02024120UL, 0x00000000UL, /* Write: MODEM.INTAFC */
  /*    4124 */ 0x078304FFUL, /* MODEM.DSATHD0 */
  0x0204412CUL, 0x0C6606FFUL, /* Write: MODEM.DSATHD2 */
  ...
  0x02024224UL, 0x00000058UL, /* Write: MODEM.FRMSCHTIME */
  /*    4228 */ 0x00000000UL, /* MODEM.PREFILTCOEFF */
  0x02024230UL, 0x00000000UL, /* Write: MODEM.SQ */
  /*    4234 */ 0x00000000UL, /* MODEM.SQEXT */
  0x0201423CUL, 0x00000000UL, /* Write: MODEM.ANTDIVCTRL */
  0x02014244UL, 0x90000014UL, /* Write: MODEM.PHDMODANTDIV */
  0x0201424CUL, 0x04000008UL, /* Write: MODEM.PHDMODCTRL */
  ...
  0x020280A0UL, 0x0003B870UL, /* Write: SYNTH.LPFCTRL1RX */
...
uint32_t ieee802154AccelerationBuffer[501];
